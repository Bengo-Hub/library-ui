...
/**
 * Global limit-reached modal for library. Opened imperatively (via useLimitModal) when a
 * mutation returns 402. Library plan limits are structural (members, titles, branches) —
