/**
 * Parses the structured 402 limit-reached body emitted by library-api (and the wider
 * platform) so the limit-reached modal can render a consistent message. Library plan
 * limits (members, titles, branches) are structural — overageEligible is always false,
